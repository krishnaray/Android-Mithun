...
import com.lict.asyncimagedownloadcustomlistView.adapter.CustomListAdapter;
import com.lict.asyncimagedownloadcustomlistView.model.NewsItem;
...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<NewsItem> imageDetailsList = getListData();
		final ListView lvListView = (ListView) findViewById(R.id.custom_list);
		lvListView.setAdapter(new CustomListAdapter(this, imageDetailsList));
		lvListView.setOnItemClickListener(new OnItemClickListener() {

			@Override
			public void onItemClick(AdapterView<?> a, View v, int position, long id) {
				Object o = lvListView.getItemAtPosition(position);
